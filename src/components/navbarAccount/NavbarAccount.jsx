            ...
            <nav className="navbar navbar-expand-lg bg-white mt-3">
                <div className="container">
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <img src={love} alt="love icon" className="ms-3 navbarHome mt-md-0" />
                        <img src={cart} alt="cart icon" className="ms-3 navbarHome mt-md-0" />
                        <img src={person} alt="person icon" className="ms-3 navbarHome mt-md-0" />
                    </div>
                </div>
                </div>
            </nav>
